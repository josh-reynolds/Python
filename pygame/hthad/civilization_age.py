...
# TO_DO: we might want to break this apart into multiple
#        strategy objects, one per population value in the match-case
#        block below
class AutumnStrategy(LocationStrategy):
    ...
    def next(self, locs: List[Location]) -> Room | None:
        ...
        # TO_DO: multiple room creation approaches below - needs standardization
    ...
    def update(self, locs: List[Location]) -> List:
        ...
        match self.step:
            ...
            case 3:
                ...
                if self.current_strategy.is_done():
                    self.step += 1
                    self.current_strategy = WinterStrategy(self.mine_start)
