...
class CargoDepot:
    ...
    def determine_cargo(self):
        ...
        table = {
                11 : Cargo("Textiles", "3Dx5", 3000, 1, {"Ag":-7,"Na":-5,"Ni":-3}, 
                                                        {"Ag":-6,"Na":1,"Ri":3}),
                12 : Cargo("Polymers", "4Dx5", 7000, 1, {"In":-2,"Ri":-3,"Po":2}, 
                                                        {"In":-2,"Ri":3}),
                13 : Cargo("Liquor", "1Dx5", 10000, 1, {"Ag":-4}, 
                                                       {"Ag":-3,"In":1,"Ri":2}),
                14 : Cargo("Wood", "2Dx10", 1000, 1, {"Ag":-6}, 
                                                     {"Ag":-6,"In":1,"Ri":2}),
                15 : Cargo("Crystals", "1Dx1", 20000, 1, {"Na":-3,"In":4}, 
                                                         {"Na":-3,"In":3,"Ri":3}),
                16 : Cargo("Radioactives", "1Dx1", 1000000, 1, {"In":7,"Ni":-3,"Ri":5}, 
                                                               {"In":6,"Ni":-3,"Ri":-4}),
                ...
                25 : Cargo("Silver", "1Dx5", 70000, 1, {"In":5,"Ri":-1,"Po":2}, 
                                                       {"In":5,"Ri":-1}),
                26 : Cargo("Special Alloys", "1Dx1", 200000, 1, {"In":-3,"Ni":5,"Ri":-2}, 
                                                                {"In":-3,"Ni":4,"Ri":-1}),
                31 : Cargo("Petrochemicals", "6Dx5", 10000, 1, {"Na":-4,"In":1,"Ni":-5}, 
                                                               {"Na":-4,"In":3,"Ni":-5}),
                32 : Cargo("Grain", "8Dx5", 300, 1, {"Ag":-2,"Na":1,"In":2}, 
                                                    {"Ag":-2}),
                33 : Cargo("Meat", "4Dx5", 1500, 1, {"Ag":-2,"Na":2,"In":3}, 
                                                    {"Ag":-2,"In":2,"Po":1}),
                34 : Cargo("Spices", "1Dx5", 6000, 1, {"Ag":-2,"Na":3,"In":2}, 
                                                      {"Ag":-2,"Ri":2,"Po":3}),
                35 : Cargo("Fruit", "2Dx5", 1000, 1, {"Ag":-3,"Na":1,"In":2}, 
                                                     {"Ag":-2,"In":3,"Po":2}),
                ...
                46 : Cargo("Body Armor", "2Dx1", 50000, 1, {"In":-1,"Ri":-3,"Po":3}, 
                                                           {"In":-2,"Ri":1,"Po":4}),
                51 : Cargo("Aircraft", "1Dx1", 1000000, 10, {"In":-4,"Ri":-3}, 
                                                            {"Ni":2,"Po":1}),
                52 : Cargo("Air/Raft", "1Dx1", 6000000, 6, {"In":-3,"Ri":-2}, 
                                                           {"Ni":2,"Po":1}),
                53 : Cargo("Computers", "1Dx1", 10000000, 2, {"In":-2,"Ri":-2}, 
                                                             {"Ag":-3,"Ni":2,"Po":1}),
                54 : Cargo("ATV", "1Dx1", 3000000, 4, {"In":-2,"Ri":-2}, 
                                                      {"Ag":1,"Ni":2,"Po":1}),
                55 : Cargo("AFV", "1Dx1", 7000000, 4, {"In":-5,"Ri":-2,"Po":4}, 
                                                      {"Ag":2,"Na":-2,"Ri":1}),
                56 : Cargo("Farm Machinery", "1Dx1", 150000, 4, {"In":-5,"Ri":-2}, 
                                                                {"Ag":5,"Na":-8,"Po":1}),
                61 : Cargo("Electronics Parts", "1Dx5", 100000, 1, {"In":-4,"Ri":-3}, 
                                                                   {"Ni":2,"Po":1}),
                62 : Cargo("Mechanical Parts", "1Dx5", 75000, 1, {"In":-5,"Ri":-3}, 
                                                                 {"Ag":2,"Ni":3}),
                63 : Cargo("Cybernetic Parts", "1Dx5", 250000, 1, {"In":-4,"Ri":-1}, 
                                                                  {"Ag":1,"Na":2,"Ni":4}),
                64 : Cargo("Computer Parts", "1Dx5", 150000, 1, {"In":-5,"Ri":-3}, 
                                                                {"Ag":1,"Na":2,"Ni":3}),
                65 : Cargo("Machine Tools", "1Dx5", 750000, 1, {"In":-5,"Ri":-4}, 
                                                               {"Ag":1,"Na":2,"Ni":3}),
                66 : Cargo("Vacc Suits", "1Dx5", 400000, 1, {"Na":-5,"In":-3,"Ri":-1}, 
                                                            {"Na":-1,"Ni":2,"Po":1})
                }
