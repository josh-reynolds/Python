...
class TerminalScreenTestCase(unittest.TestCase):
    ...
    # W0212: access to a protected member _get_destinations of a client class
    ...
    def test_get_destinations(self) -> None:
        ...
        destinations = passengers.model._get_destinations(potential_destinations,
                                                    1, "passengers")
        print(destinations)
    ...
    def test_select_passengers(self) -> None:
        ...
        selection = passengers.model._select_passengers(available, destination)
        print(selection)
